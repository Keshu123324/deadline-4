class Game {
  ...
  async start(){
    ...
    survivor1 = createSprite(120,480,10,20);
    survivor1.shapeColor = "blue";
    //survivor1.addImage();
    survivor2 = createSprite(300,500,10,20);
    survivor2.shapeColor = "blue";
    //survivor2.addImage();
    survivor3 = createSprite(500,500,10,20);
    survivor3.shapeColor = "blue";
    //survivor3.addImage();
    survivor4 = createSprite(700,500,10,20);
  ...
  play(){
    image(gameMap,0,0,displayWidth+30,displayHeight);
    form.hide();
    ...
    if(keyIsDown(UP_ARROW) && player.index !== null){
      player.ydistance =  player.ydistance+3;
      player.update();
      }
